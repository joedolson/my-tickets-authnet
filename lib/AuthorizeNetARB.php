...
if ( ! class_exists( 'AuthorizeNetARB' ) ) {
	...
	class mt_AuthorizeNetARB extends mt_AuthorizeNetRequest {
		...
		protected function _handleResponse( $response ) {
			return new mt_AuthorizeNetARB_Response( $response );
		}
 ...
 * @subpackage AuthorizeNetARB
 */
if ( ! class_exists( 'AuthorizeNetARB_Response' ) ) {
	class mt_AuthorizeNetARB_Response extends mt_AuthorizeNetXMLResponse {
