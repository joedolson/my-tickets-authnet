...
if ( ! class_exists( 'AuthorizeNetAIM' ) ) {
	class mt_AuthorizeNetAIM extends mt_AuthorizeNetRequest {
		...
		public function setField( $name, $value ) {
			if ( $this->verify_x_fields ) {
				if ( in_array( $name, $this->_all_aim_fields ) ) {
					...
					throw new mt_AuthorizeNetException( "Error: no field $name exists in the AIM API.
		...
		protected function _handleResponse( $response ) {
			return new mt_AuthorizeNetAIM_Response( $response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields );
		}
	 ...
	 * @subpackage AuthorizeNetAIM
	 */
	class mt_AuthorizeNetAIM_Response extends mt_AuthorizeNetResponse {
