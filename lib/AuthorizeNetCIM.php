...
if ( ! class_exists( 'AuthorizeNetCIM' ) ) {
	...
	class mt_AuthorizeNetCIM extends mt_AuthorizeNetRequest {
		...
		protected function _handleResponse( $response ) {
			return new mt_AuthorizeNetCIM_Response( $response );
		}
	 ...
	 * @subpackage AuthorizeNetCIM
	 */
	class mt_AuthorizeNetCIM_Response extends mt_AuthorizeNetXMLResponse {
		/**
		 * @return AuthorizeNetAIM_Response
		 */
		public function getTransactionResponse() {
			return new mt_AuthorizeNetAIM_Response( $this->_getElementContents( "directResponse" ), ",", "", array() );
		}
		...
		public function getValidationResponses() {
			...
			foreach ( (array) $responses["string"] as $response ) {
				$return[] = new mt_AuthorizeNetAIM_Response( $response, ",", "", array() );
			}
		...
		public function getValidationResponse() {
			return new mt_AuthorizeNetAIM_Response( $this->_getElementContents( "validationDirectResponse" ), ",", "", array() );
		}
