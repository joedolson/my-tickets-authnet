...
if ( ! class_exists( 'AuthorizeNetTD' ) ) {
	class mt_AuthorizeNetTD extends mt_AuthorizeNetRequest {
		...
		protected function _handleResponse( $response ) {
			return new mt_AuthorizeNetTD_Response( $response );
		}
	 ...
	 * @subpackage AuthorizeNetTD
	 */
	class mt_AuthorizeNetTD_Response extends mt_AuthorizeNetXMLResponse {
