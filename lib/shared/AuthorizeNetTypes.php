 ...
 * @subpackage AuthorizeNetCIM
 */
if ( ! class_exists( 'mt_AuthorizeNetCustomer' ) ) {
	class mt_AuthorizeNetCustomer {
	 ...
	 * @subpackage AuthorizeNetCIM
	 */
	class mt_AuthorizeNetPaymentProfile {
		...
		public function __construct() {
			$this->billTo  = new mt_AuthorizeNetAddress;
			$this->payment = new mt_AuthorizeNetPayment;
		}
	 ...
	 * @subpackage AuthorizeNetCIM
	 */
	class mt_AuthorizeNetPayment {
		public $creditCard;
		public $bankAccount;

		public function __construct() {
			$this->creditCard  = new mt_AuthorizeNetCreditCard;
			$this->bankAccount = new mt_AuthorizeNetBankAccount;
		}
	}
	 ...
	 * @subpackage AuthorizeNetCIM
	 */
	class mt_AuthorizeNetTransaction {
		public $amount;
		public $tax;
		public $shipping;
		public $duty;
	 ...
	 * @subpackage AuthorizeNetCIM
	 */
	class mt_AuthorizeNetCreditCard {
		public $cardNumber;
	 ...
	 * @subpackage AuthorizeNetCIM
	 */
	class mt_AuthorizeNetBankAccount {
		public $accountType;
	 ...
	 */
	class mt_AuthorizeNet_Subscription {
